...
public class PlayerController : MonoBehaviour
{
    ...
    public GameObject shieldTriggerObject;
    Rigidbody2D rb;
    ...
    private VisualElement shieldIndicator;    
    ...
    void Start()
    {
        ...
        IsPlayerAlive = true;
        shieldTriggerObject.SetActive(false);
        shieldIndicator = gameRoot.Q<VisualElement>("ShieldIndicator");
        
        // Make shield UI transparent
        shieldIndicator.style.opacity = 0.1f;
...
//        gameUIContainer.style.display = DisplayStyle.Flex;
    ...
    {
        shieldActive = true;
        shieldIndicator.style.opacity = 1f;
        shieldTriggerObject.SetActive(true);
